              ...
              <v-dialog v-model="dialog" max-width="1000px">
                <template v-slot:activator="{ on, attrs }">
                  <v-btn color="primary" dark class="mb-2" v-bind="attrs" v-on="on">
                    <v-icon left dark>mdi-table-plus</v-icon>領料
                  </v-btn>
                </template>
                      ...
                      <v-row mt-10 align="center" justify="center" >
                        <template>
                          <v-data-table
                            ...
                            :item-class="setRowStyleForStockIn"
...
//--stock-datatable--//
    ...
    stock_headers: [
      ...
      { text: '領料單位', value: 'stockIn_reagent_Out_unit', sortable: false, width: '90px' },
      { text: '在庫數量', value: 'stockIn_reagent_Out_cnt', sortable: false, width: '16%' },
    ],
    stock_desserts: [ ],
    temp_stock_desserts: [],
//--
  ...
  methods: {
    ...
    setRowStyleForStockIn(item) {
      return 'style-1-for-StockIn';
    },
