            ...
            <v-toolbar flat>              
              ...
              >
                ...
                <v-date-picker
                  ...
                  no-title
                  @input="findDateForPeriod = false"
                ></v-date-picker>
              </v-menu>            
              <v-spacer></v-spacer>
              <v-menu
                v-model="findDateForBegin"
                :close-on-content-click="false"
                :nudge-right="40"
              ...
              >
                ...
                <v-date-picker
                  ...
                  v-model="fromDateVal"
                  no-title
                  @input="findDateForBegin = false"
                ></v-date-picker>
              </v-menu>

              <v-spacer></v-spacer>
              <v-menu
                v-model="findDateForEnd"
                :close-on-content-click="false"
                :nudge-right="40"
...
export default {
  ...
  data: () => ({
    ...
    findDateForBegin: false,
    findDateForEnd: false,
    fromDateVal: null,
    StockDate: '',  //庫存查詢開始日期

    findDateForPeriod: false,
    fromDateValP: null,
    PeriodDate: '',  //庫存查詢開始日期
    ...
    //資料表頭
    headers: [      
      { text: 'ID', sortable: true, value: 'id', width: '4%', align: 'start' },
