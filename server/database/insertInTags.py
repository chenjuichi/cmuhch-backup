...
# --------------------------
user = [2,   2,  3,   3,  4, 5, 6, 7,   7, 7, 1]
reagent = [14, 12, 13,   9, 11, 5, 6, 7,   8, 1, 1]
grid = [9,   1,  1,   2,  4, 5, 6,  7,  7, 8, 8]
count = [6,   6,  6,   5,  5, 5, 2, 10,  2, 2, 1]
temp_cnt = [1,   1,  1,   1,  2, 5, 2,  0,  0, 0, 0]
...
print("insert 11 inTag data is ok...")
